                    ...
                    <div class="go-nav__menu-wrapper">
                        <button class="go-nav__menu-btn" id="menuBtn" aria-label="Menu">
                            ...
                            if (is_logged_in()) {
                                ...
                                // Person outline icon for logged out users
                                echo '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: block;"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>';
                            }
                            ?>
                        </button>
